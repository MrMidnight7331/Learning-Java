...
public class Array { // Define class
    ...
    public Array() { // Constructur
        ...
        for (int i = 0; i < nums.length; i+=2) { // the integer i is = 0, while i is smaller than the length of num, i + 1
            System.out.println("Nums: " + nums[i]); //print everything inside num
        }
    }
}
